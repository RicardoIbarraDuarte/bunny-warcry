...
public class EscenaJuego1 extends EscenaBase
{
    ...
    public void ataquePoruga(){
        ...
        if (tiempoAtaque==50){
            proyectil1.setX((proyectil1.getX()+7));
            proyectil2.setX((proyectil2.getX()-7));
            proyectil3.setY((proyectil3.getY()+7));
            proyectil4.setY((proyectil4.getY()-7));
            attachChild(proyectil1);
            attachChild(proyectil2);
            attachChild(proyectil3);
            attachChild(proyectil4);
            if ((proyectil1.getX()==xinicial+70)){
                proyectil1.detachSelf();
                proyectil1.dispose();
                ataqueInicio=true;
            }
            if ((proyectil2.getX()==xinicial+70)){
                proyectil2.detachSelf();
                proyectil2.dispose();
                ataqueInicio=true;
            }
            if ((proyectil3.getX()==yinicial+70)){
                proyectil3.detachSelf();
                proyectil3.dispose();
                ataqueInicio=true;
            }
            if ((proyectil4.getX()==yinicial+70)){
